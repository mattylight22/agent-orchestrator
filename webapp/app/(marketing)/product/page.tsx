...
export const metadata: Metadata = { title: "Product", description: "See how Agent God Mode turns plans into isolated, reviewed GitHub workstreams." };

export default function ProductPage() {
  return <main className="marketing-subpage"><section className="marketing-page-hero"><span className="marketing-kicker">The product</span><h1>A deliberate operating system for coding agents.</h1><p>Coordinate planning, implementation, review, and delivery across repositories without flattening every job into an unstructured chat.</p></section>
    <section className="product-feature-row"><div><span>01 · Workstreams</span><h2>Parallel work without branch collisions.</h2><p>Every workstream owns a GitHub branch and an isolated Paseo workspace created from the selected base branch. Agents share context inside that workstream without sharing a dirty sandbox.</p><ul><li><GitBranch/>Configurable branch naming</li><li><Settings2/>Repository and host selection</li><li><MessageSquare/>Follow-ups stay in the same agent session</li></ul></div><WorkstreamDiagram/></section>
